<script lang="ts">
	...
	$: if (episodeData && slug && typeof window !== 'undefined') {
		watchHistory.add({
			slug: slug,
				...
				<div class="player-card">
					...
					<div class="episode-nav">
						{#if episodeData.hasPrevEpisode && episodeData.prevEpisode}
							<a href={`/watch/${episodeData.prevEpisode.episodeId}`} class="nav-btn prev">
						...
						<a href={`/detail/${episodeData.animeId}`} class="nav-btn home">
							<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
						...
						{#if episodeData.hasNextEpisode && episodeData.nextEpisode}
							<a href={`/watch/${episodeData.nextEpisode.episodeId}`} class="nav-btn next">
					...
					<div class="episodes-card">
						...
						<div class="episodes-list">
							{#each episodeData.info.episodeList as episode}
								{@const isCurrent = episode.episodeId === slug}
								<a 
