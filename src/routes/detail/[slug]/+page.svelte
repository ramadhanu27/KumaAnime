					...
					<div class="anime-info">
						...
						<div class="action-buttons">
							{#if animeDetail.episodeList && animeDetail.episodeList.length > 0}
								<a href={`/watch/${encodeURIComponent(animeDetail.episodeList[animeDetail.episodeList.length - 1].episodeId)}`} class="btn-primary">
							...
							{#if animeDetail.batch}
								<a href={`/batch/${encodeURIComponent(animeDetail.batch.batchId)}`} class="btn-secondary btn-batch">
							...
							<div class="connections-section">
								...
								<div class="connections-list">
									{#each animeDetail.synopsis.connections as connection}
										<a href={`/detail/${connection.animeId}`} class="connection-link">
											{connection.title}
										</a>
									{/each}
								</div>
						...
						<div class="content-card">
							...
							<div class="recommended-grid">
								{#each animeDetail.recommendedAnimeList as rec}
									<a href={`/detail/${rec.animeId}`} class="recommended-card">
				...
				<aside class="sidebar-content">
					...
					{#if animeDetail.genreList && animeDetail.genreList.length > 0}
						<div class="content-card">
							...
							<div class="cast-grid">
								{#each animeDetail.genreList as genre}
									<a href={`/genre/${genre.genreId}`} class="cast-chip">
										{genre.title}
									</a>
								{/each}
							</div>
